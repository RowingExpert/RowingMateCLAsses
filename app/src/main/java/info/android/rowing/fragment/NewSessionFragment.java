...
import info.android.rowing.activity.MainActivity;
...
public class NewSessionFragment extends Fragment {
    ...
    public static NewSessionFragment newInstance(String param1, String param2) {
    ...
    public void onStart(){
        super.onStart();
        Button  startNewSession = (Button) context.findViewById(R.id.start_button);
        startNewSession.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            context.startActivity(new Intent(context, NewSessionActivity.class));
        }
        });
    }
